...
static void setWindowText( GameWindow *window, AsciiString textLabel )
{
	...
	if( BitTest_( window->winGetStyle(), GWS_PUSH_BUTTON ) )
		GadgetButtonSetText( window, theText );
	else if( BitTest_( window->winGetStyle(), GWS_RADIO_BUTTON ) )
		GadgetRadioSetText( window, theText );
	else if( BitTest_( window->winGetStyle(), GWS_CHECK_BOX ) )
		GadgetCheckBoxSetText( window, theText );
	else if( BitTest_( window->winGetStyle(), GWS_STATIC_TEXT ) )
		GadgetStaticTextSetText( window, theText );
	else if( BitTest_( window->winGetStyle(), GWS_ENTRY_FIELD ) )
	{
															 ...
															 char *buffer )
{
  GameWindow *lastWindow;
	...
	if( BitTest_( window->winGetStyle(), GWS_TAB_CONTROL ) )
	{
